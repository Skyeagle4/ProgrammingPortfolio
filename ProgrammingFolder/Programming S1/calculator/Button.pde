class Button {
  ...
  boolean isOpT, isOpPR, isOpPL, isOpTri;
  boolean isSpec, isSpecS;
  float numButVal;
  String opButVal;
  String spButVal;
  float xpos, ypos;
  ...
  Button asOpTri(int px1, int py1, int px2, int py2, int px3, int py3, String OpButVal) {
    this.px1 = px1;
    this.py1 = py1;
    this.px2 = px2;
    this.py2 = py2;
  ...
  Button asSpec( int px1, int py1, int px2, int py2, int px3, int py3, String SpecButVal) {
    this.px1 = px1;
    this.py1 = py1;
    this.px2 = px2;
    this.py2 = py2;
    this.px3 = px3;
    this.py3 = py3;
    this.spButVal = SpecButVal;
    over = false;
    isSpec = true;
    return this;
  }

  Button asSpecS( int px1, int py1, int px2, int py2, int px3, int py3, String SpecButVal) {
    this.px1 = px1;
    this.py1 = py1;
    this.px2 = px2;
    this.py2 = py2;
  ...
  void click () {
    ...
    } else if (isOpTri || isSpecS) {
      over = mouseX > x && mouseX < x+20 && mouseY > y-60 && mouseY < y;
    } else if (isSpec) {
      over = mouseX > x && mouseX < x+40 && mouseY > y-40 && mouseY < y;
    }
  }
